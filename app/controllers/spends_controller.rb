class SpendsController < ApplicationController
  ...
  def destroy
    @spend.destroy
    respond_to do |format|
      format.html { redirect_to spend_url, notice: 'Spend was successfully destroyed.' }
    end
  end
  ...
  private
    ...
    def spend_params
      params.require(:spend).permit(:name, :category, :spend_group, :always_positive, :icon, lookups: [])
    end
